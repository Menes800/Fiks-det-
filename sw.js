const CACHE = 'hvor-er-den-v18';
const ASSETS = [
  './', './index.html', './styles.css?v=4', './v1.css?v=1', './cloud.css?v=1',
  './v21/v21-modular.css?v=1', './v22/v22.css?v=1', './v22/v22-compact-ui.css?v=1', './v23/v23.css?v=1',
  ...
  './v22/v22-data.js?v=1', './v23/v23-catalog.js?v=1', './v23/v23-ai.js?v=1', './v23/v23-wizard.js?v=1',
  './v22/v22-mobile-hotfix.js?v=1', './v22/v22-lists.js?v=1', './v22/v22-compact-ui.js?v=1', './v22/v22-bridge.js?v=1', './v22/v22-polish.js?v=1',

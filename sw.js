const CACHE = 'hvor-er-den-v20';
const ASSETS = [
  './', './index.html', './styles.css?v=4', './v1.css?v=1', './cloud.css?v=1',
  './v21/v21-modular.css?v=1', './v22/v22.css?v=1', './v22/v22-compact-ui.css?v=1', './v23/v23.css?v=1', './v24/v24.css?v=1', './v24/v24-polish.css?v=1', './v25/v25.css?v=1',

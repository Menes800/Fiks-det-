const CACHE = 'hvor-er-den-v26';
const ASSETS = [
  './', './index.html', './styles.css?v=4', './v1.css?v=1', './cloud.css?v=1',
  './v21/v21-modular.css?v=1', './v22/v22.css?v=1', './v22/v22-compact-ui.css?v=1', './v23/v23.css?v=1', './v24/v24.css?v=1', './v24/v24-polish.css?v=1', './v25/v25.css?v=1', './v26/v26.css?v=1', './v27/v27.css?v=1', './v27/v27-undo.css?v=1', './v27/v27-account-screen.css?v=1',
  ...
  './v27/v27-invites.js?v=1', './v27/v27.js?v=2', './v27/v27-undo.js?v=1', './v27/v27-account-screen.js?v=1',
...
self.addEventListener('fetch', (event) => {
  ...
  event.respondWith(fetch(event.request).then((response) => { if (!response.ok) return response; const copy = response.clone(); caches.open(CACHE).then((cache) => cache.put(event.request, copy)); return response; }).catch(() => caches.match(event.request).then((cached) => cached || caches.match('./index.html'))));
});

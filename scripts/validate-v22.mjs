...
if (!serviceWorker.includes("hvor-er-den-v17")) throw new Error('Service worker bruker feil cacheversjon');
...
if (!compactUi.includes('v22-is-unpack') || !compactUi.includes('Flere valg') || !compactUi.includes('Listevalg')) throw new Error('Kompakt listevisning mangler');
if (!compactCss.includes('.v22-quick-add') || !compactCss.includes('.v22-is-unpack .v22-add-item--compact')) throw new Error('Kompakt listestil mangler');
...
const assets = [
  './v22/v22.css?v=1',
  './v22/v22-compact-ui.css?v=1',
  './v22/v22-data.js?v=1',
  './v22/v22-mobile-hotfix.js?v=1',
  './v22/v22-lists.js?v=1',
  './v22/v22-compact-ui.js?v=1',
...
console.log(`Hvor er den? 2.2 validert: ${v22Scripts.length} moduler, kompakt listevisning, turmaler, pakk-ut-modus, medlemsgrense og mobil-hotfix.`);
